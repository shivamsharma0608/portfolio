...
function processCommits(data) {
  return d3
    ...
    .map(([commit, lines]) => {
      ...
      let ret = {
        id: commit,
        url: 'https://github.com/shivamsharma0608/portfolio/commit/' + commit,
        author,
        date,
        time,
        timezone,
...
// Declare scales outside so brushing can access them
let xScale, yScale;

// isCommitSelected needs scales in scope
...
function renderScatterPlot(data, commits) {
  ...
  // Scales (assigned to outer variables for brush access)
  xScale = d3
    .scaleTime()
